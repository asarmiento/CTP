...
<a href="grupos/create" class="btn btn-primary">Agregar <span class="badge">+</span></a>
</div>
<div style="float: left; padding: 5px;">
...
<table class="table">
    ...
    <tbody>    
        ...
        <tr>  
            ...
            <td>{{$datos->codigo}}</td>
            <td>{{($datos->nombre)}}</td>
            <td><a class="btn btn-warning" href="{{URL::action('GruposController@edit',$datos->id)}}"><span class="glyphicon glyphicon-pencil"></span></a></td>
        </tr>
        @endforeach
